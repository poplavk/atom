...
--накатить схему:
--psql -h wtfis.ru -U atom41 -a -d chatdb_atom41 -f ./dbhackaton/src/main/resources/sql/schema/atom_bd.sql
--psql -h wtfis.ru -U atom41 -a -d chatdb_atom41 -f /home/mkai/IdeaProjects/atom/dbhackaton/src/main/resources/sql/schema/atom_bd.sql
